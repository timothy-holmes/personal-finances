...
from swagger_client.models.create_webhook_request import CreateWebhookRequest  # noqa: E501
...
class TestCreateWebhookRequest(unittest.TestCase):
    ...
    def testCreateWebhookRequest(self):
        ...
        # model = swagger_client.models.create_webhook_request.CreateWebhookRequest()  # noqa: E501
        pass
